...
export default function EditAppointmentModal({ isOpen, onClose, onAppointmentUpdated, appointment }: EditAppointmentModalProps) {
  ...
  useEffect(() => {
    if (appointment) {
      // Преобразуем дату из ISO формата в формат для input[type="date"] и input[type="time"]
      ...
      setFormData({
        ...
        treatment_type: appointment.treatment_type || 'consultation',
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
      <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        <div className="mt-3">
          <h3 className="text-lg font-medium text-gray-900">Редактировать запись</h3>
